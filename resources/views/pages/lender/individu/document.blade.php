                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="file_preview">
                                                                            <img class="img-file"
                                                                                src="{{ asset('/upload/lender/individu/file/attachment') }}/{{ $attachment->npwp ?? '' }}"
                                                                                id="photo_ktp_preview" alt="" style="width:100%">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="file_preview">
                                                                            <img class="img-file"
                                                                                src="{{ asset('/upload/lender/individu/file/attachment') }}/{{ $attachment->npwp ?? '' }}"
                                                                                id="selfie_photo_preview" alt="" style="width:100%">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col">
                                                                        <div class="upload-file">
                                                                            <div class="file-input">
                                                                                <input type="file" id="photo_npwp" name="photo_npwp"
                                                                                    class="file">
                                                                        ...
                                                                        <div class="file_preview">
                                                                            <img class="img-file"
                                                                                src="{{ asset('/upload/lender/individu/file/attachment') }}/{{ $attachment->npwp ?? '' }}"
                                                                                id="photo_npwp_preview" alt="" style="width:100%">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col">
                                                                        <div class="upload-file">
                                                                            <div class="file-input">
                                                                                <input type="file" id="photo_id_card" name="photo_id_card"
                                                                                    class="file">
                                                                        ...
                                                                        <div class="file_preview">
                                                                            <img class="img-file"
                                                                                src="{{ asset('/upload/lender/individu/file/attachment') }}/{{ $attachment->npwp ?? '' }}"
                                                                                id="photo_id_card_preview" alt="" style="width:100%">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="row mt-2">
                                                                    <div class="col">
                                                                        <div class="upload-file">
                                                                            <div class="file-input">
                                                                                <input type="file" id="photo_salary_slip" name="photo_salary_slip"
                                                                                    class="file">
                                                                        ...
                                                                        <div class="file_preview">
                                                                            <img class="img-file"
                                                                                src="{{ asset('/upload/lender/individu/file/attachment') }}/{{ $attachment->npwp ?? '' }}"
                                                                                id="photo_salary_slip_preview" alt="" style="width:100%">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
