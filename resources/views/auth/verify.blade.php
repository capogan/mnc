                        ...
                        <div class="row">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    {{ __('Untuk proses verifikasi akun, silahkan check email Anda') }}
                                    {{ __('Jika Anda tidak menerima email') }},
                                    <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                        @csrf
                                        <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('tekan tombol untuk permintaan ulang') }}</button>.
                                    </form>
                                </div>
                            </div>
                        </div>
