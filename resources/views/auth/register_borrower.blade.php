...
@section('content')
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-2 offset-2" style="z-index: 1">
                    <img src="/images/Aset SIAP - MrSiap.png" style="margin-top: 100px;">
                </div>
                <div class="col-6 mt-5" style="margin-left: -60px;">
                    <div class="card border-0 pt-4" style="border-radius: 15px; box-shadow: 4px 4px 20px rgb(224, 223, 223);">
                        <h4 class="card-title text-center">Buat Akun</h4>
                        <p class="text-center mb-0">Silahkan Membuat Akun anda</p>
