...
class LenderController extends Controller
{
    ...
    public function submit_attachment_data(Request $request){
        ...
        [
                'npwp' => 'required|image|mimes:png,jpg|size:1000',
                'tdp'     => 'required|mimes:pdf|size:1000',
                'nib'     => 'required|mimes:pdf|size:1000',
                'doc_kta'   => 'required|mimes:pdf|size:1000',
                'doc_last_ahu'   => 'required|mimes:pdf|size:1000',
                'organizational_structure'   => 'required|mimes:pdf|size:1000',
                'balance_report'   => 'required|mimes:pdf|size:1000',
                'cash_flow'   => 'required|mimes:pdf|size:1000',
                'loss_profit'   => 'required|mimes:pdf|size:1000',
        ],
        [
